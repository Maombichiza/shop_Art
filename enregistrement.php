            ...
            <div class="boxcontact"><!-- box begin -->
              <div class="box-header"><!-- box-header  begin-->
                <center><!-- center  begin-->
                  ...
                  <form action="enregistrement.php" method="post" enctype="multipart/form-data"><!-- form  begin-->
                    ...
                    <div class="form-group"><!-- form-group  begin-->
                      ...
                      <input type="file" class="form-control form-height-customer"  name="u_image" required></input>
                    </div><!-- form-group  finish-->
                    
                    <div class="text-center" ><!-- text-center  begin-->
                      <button  type="submit" name="register" class="btn btn-primary"><i class="fa fa-user-md"> Enregistrer </i> </button>
