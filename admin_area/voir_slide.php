                    ...
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="index.php?supprimer_slide=<?php echo $slide_id; ?>" class="pull-right"><!-- pull-right begin -->
                                
                                 <i class="fa fa-trash"></i> Supprimer
                                
                                </a><!-- pull-right finish -->
                                
                                <a href="index.php?modifier_slide=<?php echo $slide_id; ?>" class="pull-left"><!-- pull-left begin -->
